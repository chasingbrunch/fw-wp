...
<?php if( have_rows( 'hero_slider' ) ): ?>
	...
	<div class="home-slider hero-slider">
		...
		<?php while ( have_rows( 'hero_slider' ) ) : the_row(); ?>
			...
			<?php $alignment = get_sub_field( 'alignment' );
				  ...
				  preg_match('/src="(.+?)"/', $video, $url);
				  $video_source = parse_video_uri( $url[1] );
				  $headline = get_sub_field('headline');
				  $sub_headline = get_sub_field('sub-headline');
				  $caption = get_sub_field('caption');
				  $url = get_sub_field( 'url' ); ?>
				  
				  <a class="hero-slide hero-banner grid-x" href="<?php echo $url; ?>">
					  
					<?php if( $slide_type == 'video' && $video_source['type'] == 'youtube' ): ?>
					
						<div data-youtube="https://www.youtube.com/watch?v=<?php echo $video_source['id']; ?>"></div>
...
<?php if( have_rows( 'content_cards' ) ): ?>
	...
	<div class="content-cards grid-x">
					...
					<?php 
						...
						if( $content_type == 'event' ) {
							...
							foreach( $artist as $term ) {
								...
								$content .= '<p>' . $term->name . '</p>';
				
							}
							
							$url = get_post_permalink( $event );
							
						} 
						
						?>
					
					<a class="content-card small-12 medium-3 cell" href="<?php echo $url; ?>">
			...
			<div class="artist small-10 small-offset-1 cell">
				...
				<div class="grid-x">
					...
					<div class="small-12 medium-8 cell">
						...
						<div class="grid-x highlight-reel">
